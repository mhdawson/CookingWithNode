...
Server.startServer = function(server) {
  ...
  // for testing
  probes['test'] = {type: 'temp', id: 'test', temp:  25.5, timestamp: (new Date().getTime()/1000), meat: 'beef', taste: 'medium', target:  71, scaleC: scaleC};
  probes['test2'] = {type: 'temp', id: 'test2', temp: 25.51, timestamp: new Date().getTime()/1000, meat: 'beef', taste: 'medium', target: 71, scaleC: scaleC};
probesHistory['test'] = { timestamps: [(new Date().getTime()/1000) - 20,(new Date().getTime()/1000) - 10] , temps: [ 25.5, 26], targets: [71,71 ] };
